...
import { ArrowLeftIcon ,ChevronLeftIcon,ChevronRightIcon,QuestionMarkCircleIcon } from 'react-native-heroicons/outline'
import { ChevronDoubleRightIcon, MapPinIcon,  StarIcon } from 'react-native-heroicons/solid'
      ...
      <View className='relative'>
        ...
        <View className='bg-white'>
            ...
            <Text className="text-gray-500" >Nearby . {address}</Text>
                ...
                <Text className='pb-4 text-gray-500 mt-2'>
                {short_description}
            </Text>
