import { View, Text, SafeAreaView, SafeAreaViewComponent, TouchableOpacity, Image, ScrollView } from 'react-native'
    ...
    <SafeAreaView className='flex-1 bg-white'>
      <View className='flex-1 bg-gray-100'>
        <View className='p-6 border-b border-[#00CCBB] bg-white shadow-xs'>
            ...
            <TouchableOpacity className='absolute  top-3 right-5 bg-gray-100 rounded-full' onPress={navigation.goBack}>
        ...
        <View className='flex-row items-center space-x-4 px-4 py-3 bg-white my-5'>
            ...
            <Text className='flex-1'>Deliver in 25-50 min</Text>
            <TouchableOpacity>
        ...
        <View className='p-5 bg-white mt-5 space-y-4'>
            ...
            <View className='flex-row justify-between'>
                ...
                <Text className='text-gray-400'>
                    <Currency quantity={5.66} currency='usd'/>
                </Text>
            </View>
            <View className='flex-row justify-between'>
                <Text className=''>Order Total</Text>
                <Text className='font-extrabold'>
                    <Currency quantity={basketTotal +5.66} currency='usd'/>
                </Text>
            </View>
